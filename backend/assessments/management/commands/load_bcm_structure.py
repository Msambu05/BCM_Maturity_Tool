...
class Command(BaseCommand):
    help = 'Load BCM Maturity Assessment structure with components, focus areas, and questions'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('BCM structure loading completed!'))
